...
loop:                                             ; preds = %cond
  ...
  %8 = load i8, i8* %7
  store i8 %8, i32* %t
  %9 = load i32, i32* %HashVal
  %multmpi = mul i32 %9, 32
  %10 = load i32, i32* %t
  %addtmpi = add i32 %multmpi, %10
  store i32 %addtmpi, i32* %HashVal
  %11 = load i32, i32* %i
  %addtmpi1 = add i32 %11, 1
  store i32 %addtmpi1, i32* %i
  br label %cond

loopend:                                          ; preds = %cond
  %12 = load i32, i32* %HashVal
  %13 = load i32, i32* %TableSize
  %divtmpi = sdiv i32 %12, %13
  store i32 %divtmpi, i32* %quotient
  %14 = load i32, i32* %HashVal
  %15 = load i32, i32* %quotient
  %16 = load i32, i32* %TableSize
  %multmpi2 = mul i32 %15, %16
  %subtmpi = sub i32 %14, %multmpi2
...
forcond124:                                       ; preds = %forbody126, %then120
  %156 = load i32, i32* %j
  %157 = load i32, i32* %i
  %158 = getelementptr [100 x %Course], [100 x %Course]* %type1, i32 0, i32 %157
  %159 = getelementptr %Course, %Course* %158, i32 0, i32 2
  %160 = load i32, i32* %159
  %cmptmpi127 = icmp slt i32 %156, %160
...
forbody126:                                       ; preds = %forcond124
  %161 = load i32, i32* %i
  %162 = getelementptr [100 x %Course], [100 x %Course]* %type1, i32 0, i32 %161
  %163 = getelementptr %Course, %Course* %162, i32 0, i32 4
  %164 = load i32, i32* %j
  %165 = getelementptr [5 x i8], [5 x i8]* %163, i32 0, i32 %164
  %166 = load i8, i8* %165
  %printf128 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @20, i32 0, i32 0), i8 %166)
  %167 = load i32, i32* %j
  %addtmpi129 = add i32 %167, 1
...
forcond131:                                       ; preds = %ifend140, %else121
  %168 = load i32, i32* %j
  %169 = load i32, i32* %i
  %170 = getelementptr [100 x %Course], [100 x %Course]* %type1, i32 0, i32 %169
  %171 = getelementptr %Course, %Course* %170, i32 0, i32 0
  %172 = load i32, i32* %171
  %cmptmpi134 = icmp slt i32 %168, %172
  br i1 %cmptmpi134, label %forbody133, label %forend132

forend132:                                        ; preds = %forcond131
  %173 = load i8, i8* %temp
  %cmptmpi215 = icmp ne i8 %173, 59
  %ifCond216 = icmp ne i1 %cmptmpi215, false
  br i1 %ifCond216, label %then217, label %else218

forbody133:                                       ; preds = %forcond131
  %174 = load i32, i32* %i
  %175 = getelementptr [100 x %Course], [100 x %Course]* %type1, i32 0, i32 %174
  %176 = getelementptr %Course, %Course* %175, i32 0, i32 1
  %177 = load i32, i32* %j
  %178 = getelementptr [500 x i8], [500 x i8]* %176, i32 0, i32 %177
  %179 = load i8, i8* %178
  store i8 %179, i8* %temp
  %180 = load i8, i8* %temp
  %cmptmpi135 = icmp eq i8 %180, 44
  %181 = load i8, i8* %temp
  %cmptmpi136 = icmp eq i8 %181, 59
...
then138:                                          ; preds = %forbody133
  %182 = load i32, i32* %index
  store i32 %182, i32* %z
  br label %forcond141

else139:                                          ; preds = %forbody133
  %183 = load i8, i8* %temp
  %184 = load i32, i32* %index
  %185 = getelementptr [5 x i8], [5 x i8]* %tName, i32 0, i32 %184
  store i8 %183, i8* %185
  %186 = load i32, i32* %index
  %addtmpi213 = add i32 %186, 1
  store i32 %addtmpi213, i32* %index
  br label %ifend140

ifend140:                                         ; preds = %else139, %ifend207
  %187 = load i32, i32* %j
  %addtmpi214 = add i32 %187, 1
  store i32 %addtmpi214, i32* %j
  br label %forcond131

forcond141:                                       ; preds = %forbody143, %then138
  %188 = load i32, i32* %z
  %cmptmpi144 = icmp slt i32 %188, 5
  br i1 %cmptmpi144, label %forbody143, label %forend142

forend142:                                        ; preds = %forcond141
  %189 = load i32, i32* %index
  %190 = load i32, i32* %tableSize
  %call146 = call i32 @HashFunc(i32 %189, i32 %190, [5 x i8]* %tName)
  store i32 %call146, i32* %tHash
  store i32 0, i32* %index
  %191 = load i32, i32* %tHash
  %192 = getelementptr [1000 x i32], [1000 x i32]* %myHashTable, i32 0, i32 %191
  %193 = load i32, i32* %192
  %cmptmpi147 = icmp eq i32 %193, 0
...
then159:                                          ; preds = %else150
  %203 = load i32, i32* %isOk
  %cmptmpi162 = icmp eq i32 %203, 1
  %ifCond163 = icmp ne i1 %cmptmpi162, false
  br i1 %ifCond163, label %then164, label %else165

else160:                                          ; preds = %else150
  %204 = load i32, i32* %tHash
  %205 = getelementptr [1000 x i32], [1000 x i32]* %myHashTable, i32 0, i32 %204
  %206 = load i32, i32* %205
  %cmptmpi167 = icmp eq i32 %206, 2
...
then169:                                          ; preds = %else160
  %207 = load i32, i32* %isOk
  %cmptmpi172 = icmp eq i32 %207, 1
...
forcond177:                                       ; preds = %ifend195, %else170
  %208 = load i32, i32* %k
  %209 = load i32, i32* %totalCourse
  %cmptmpi180 = icmp slt i32 %208, %209
...
forcond181:                                       ; preds = %ifend189, %forbody179
  %210 = load i32, i32* %z
  %cmptmpi184 = icmp slt i32 %210, 5
  br i1 %cmptmpi184, label %forbody183, label %forend182

forend182:                                        ; preds = %forcond181
  %211 = load i32, i32* %flag
  %cmptmpi191 = icmp eq i32 %211, 1
  %ifCond192 = icmp ne i1 %cmptmpi191, false
  br i1 %ifCond192, label %then193, label %else194

forbody183:                                       ; preds = %forcond181
  %212 = load i32, i32* %k
  %213 = getelementptr [100 x %Course], [100 x %Course]* %type1, i32 0, i32 %212
  %214 = getelementptr %Course, %Course* %213, i32 0, i32 4
  %215 = load i32, i32* %z
  %216 = getelementptr [5 x i8], [5 x i8]* %214, i32 0, i32 %215
  %217 = load i8, i8* %216
  %218 = load i32, i32* %z
  %219 = getelementptr [5 x i8], [5 x i8]* %tName, i32 0, i32 %218
  %220 = load i8, i8* %219
  %cmptmpi185 = icmp ne i8 %217, %220
...
ifend189:                                         ; preds = %else188, %then187
  %221 = load i32, i32* %z
  %addtmpi190 = add i32 %221, 1
  store i32 %addtmpi190, i32* %z
  br label %forcond181

then193:                                          ; preds = %forend182
  %222 = load i32, i32* %k
  %223 = getelementptr [100 x %Course], [100 x %Course]* %type1, i32 0, i32 %222
  %224 = getelementptr %Course, %Course* %223, i32 0, i32 3
  %225 = load i32, i32* %224
  %cmptmpi196 = icmp eq i32 %225, 1
  %226 = load i32, i32* %isOk
  %cmptmpi197 = icmp eq i32 %226, 1
...
ifend201:                                         ; preds = %else200, %then199
  %228 = load i32, i32* %totalCourse
  store i32 %228, i32* %k
  br label %ifend195

then205:                                          ; preds = %ifend151
  %229 = load i32, i32* %isOk
  %cmptmpi208 = icmp eq i32 %229, 1
...
then210:                                          ; preds = %then205
  %230 = load i32, i32* %i
  %231 = getelementptr [100 x %Course], [100 x %Course]* %type1, i32 0, i32 %230
  %232 = getelementptr %Course, %Course* %231, i32 0, i32 0
...
then217:                                          ; preds = %forend132
  %234 = load i32, i32* %index
  store i32 %234, i32* %nameSize
  %235 = load i32, i32* %index
  store i32 %235, i32* %z
  br label %forcond220
...
ifend219:                                         ; preds = %else218, %ifend230
  %236 = load i32, i32* %isOk
  %cmptmpi283 = icmp eq i32 %236, 1
  %ifCond284 = icmp ne i1 %cmptmpi283, false
  br i1 %ifCond284, label %then285, label %else286

forcond220:                                       ; preds = %forbody222, %then217
  %237 = load i32, i32* %z
  %cmptmpi223 = icmp slt i32 %237, 5
  br i1 %cmptmpi223, label %forbody222, label %forend221

forend221:                                        ; preds = %forcond220
  %238 = load i32, i32* %nameSize
  %239 = load i32, i32* %tableSize
  %call225 = call i32 @HashFunc(i32 %238, i32 %239, [5 x i8]* %tName)
  store i32 %call225, i32* %tHash
  %240 = load i32, i32* %tHash
  %241 = getelementptr [1000 x i32], [1000 x i32]* %myHashTable, i32 0, i32 %240
  %242 = load i32, i32* %241
  %cmptmpi226 = icmp eq i32 %242, 0
...
forbody222:                                       ; preds = %forcond220
  %243 = load i8, i8* %zero
  %244 = load i32, i32* %z
  %245 = getelementptr [5 x i8], [5 x i8]* %tName, i32 0, i32 %244
  store i8 %243, i8* %245
  %246 = load i32, i32* %z
  %addtmpi224 = add i32 %246, 1
  store i32 %addtmpi224, i32* %z
  br label %forcond220

then228:                                          ; preds = %forend221
  %247 = load i32, i32* %isOk
  %cmptmpi231 = icmp eq i32 %247, 1
  %ifCond232 = icmp ne i1 %cmptmpi231, false
  br i1 %ifCond232, label %then233, label %else234

else229:                                          ; preds = %forend221
  %248 = load i32, i32* %tHash
  %249 = getelementptr [1000 x i32], [1000 x i32]* %myHashTable, i32 0, i32 %248
  %250 = load i32, i32* %249
  %cmptmpi236 = icmp eq i32 %250, 1
...
then238:                                          ; preds = %else229
  %251 = load i32, i32* %isOk
  %cmptmpi241 = icmp eq i32 %251, 1
  %ifCond242 = icmp ne i1 %cmptmpi241, false
  br i1 %ifCond242, label %then243, label %else244

else239:                                          ; preds = %else229
  %252 = load i32, i32* %tHash
  %253 = getelementptr [1000 x i32], [1000 x i32]* %myHashTable, i32 0, i32 %252
  %254 = load i32, i32* %253
  %cmptmpi246 = icmp eq i32 %254, 2
...
then248:                                          ; preds = %else239
  %255 = load i32, i32* %isOk
  %cmptmpi251 = icmp eq i32 %255, 1
...
forcond256:                                       ; preds = %ifend274, %else249
  %256 = load i32, i32* %k
  %257 = load i32, i32* %totalCourse
  %cmptmpi259 = icmp slt i32 %256, %257
...
forcond260:                                       ; preds = %ifend268, %forbody258
  %258 = load i32, i32* %z
  %cmptmpi263 = icmp slt i32 %258, 5
  br i1 %cmptmpi263, label %forbody262, label %forend261

forend261:                                        ; preds = %forcond260
  %259 = load i32, i32* %flag
  %cmptmpi270 = icmp eq i32 %259, 1
  %ifCond271 = icmp ne i1 %cmptmpi270, false
  br i1 %ifCond271, label %then272, label %else273

forbody262:                                       ; preds = %forcond260
  %260 = load i32, i32* %k
  %261 = getelementptr [100 x %Course], [100 x %Course]* %type1, i32 0, i32 %260
  %262 = getelementptr %Course, %Course* %261, i32 0, i32 4
  %263 = load i32, i32* %z
  %264 = getelementptr [5 x i8], [5 x i8]* %262, i32 0, i32 %263
  %265 = load i8, i8* %264
  %266 = load i32, i32* %z
  %267 = getelementptr [5 x i8], [5 x i8]* %tName, i32 0, i32 %266
  %268 = load i8, i8* %267
  %cmptmpi264 = icmp ne i8 %265, %268
...
ifend268:                                         ; preds = %else267, %then266
  %269 = load i32, i32* %z
  %addtmpi269 = add i32 %269, 1
  store i32 %addtmpi269, i32* %z
  br label %forcond260

then272:                                          ; preds = %forend261
  %270 = load i32, i32* %k
  %271 = getelementptr [100 x %Course], [100 x %Course]* %type1, i32 0, i32 %270
  %272 = getelementptr %Course, %Course* %271, i32 0, i32 3
  %273 = load i32, i32* %272
  %cmptmpi275 = icmp eq i32 %273, 1
  %274 = load i32, i32* %isOk
  %cmptmpi276 = icmp eq i32 %274, 1
...
forcond289:                                       ; preds = %forbody291, %then285
  %277 = load i32, i32* %j
  %278 = load i32, i32* %i
  %279 = getelementptr [100 x %Course], [100 x %Course]* %type1, i32 0, i32 %278
  %280 = getelementptr %Course, %Course* %279, i32 0, i32 2
  %281 = load i32, i32* %280
  %cmptmpi292 = icmp slt i32 %277, %281
...
forbody291:                                       ; preds = %forcond289
  %282 = load i32, i32* %i
  %283 = getelementptr [100 x %Course], [100 x %Course]* %type1, i32 0, i32 %282
  %284 = getelementptr %Course, %Course* %283, i32 0, i32 4
  %285 = load i32, i32* %j
  %286 = getelementptr [5 x i8], [5 x i8]* %284, i32 0, i32 %285
  %287 = load i8, i8* %286
  %printf293 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @24, i32 0, i32 0), i8 %287)
  %288 = load i32, i32* %j
  %addtmpi294 = add i32 %288, 1
